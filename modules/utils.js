...
/**
 * @typedef {import("/modules/database.js").EntryChanges} EntryChanges
 ...
 * @property {(arg: {feeds: string[], entries: any, changes: EntryChanges}) => void} entries-updated
 ...
 * @property {(arg: {feedUpdates: Feed[]}) => void} feedlist-updated
